...
<?php
   ...
   if ($acao=="cad_informacoes") {
    ...
    $stmt = $conexao->prepare('INSERT INTO tb_informacoes (informacoes)VALUES (:informacoes)');
      ...
      if ($stmt->execute() == TRUE) {
       $_SESSION['cad_infor'] = 1;
        echo "<script>window.location.href='?pg=processo_seletivo&acao=listar_informacoes';</script>"; 
      }else{
        echo "";
      }
   }if ($acao=="adicionar_informacoes") {
   ?>
      ...
      <div class="col-md-12">
         <div class="box box-success">
            <div class="box-header with-border">
               <h3 class="box-title">Adicionar Informações</h3>
            </div>
            <div class="box-body">
               <div class="logo col-md-12">
                  <form class="form-horizontal" action="?pg=processo_seletivo&acao=cad_informacoes" method="POST">
                     <div class="box-body">
...
<section class="content container-fluid">
   <div class="row">
      <div class="col-md-12">
         <div class="box box-success">
            <div class="box-header with-border">
               <h3 class="box-title">Vizualizar Informações</h3>
            </div>
            <div class="box-body">
               <?php 
                  if (isset($_SESSION['cad_infor'])) {
                      if ( $_SESSION['cad_infor']== 1 ) {
                      echo '
                          <br>
                          <div class="alert alert-success " id="success-alert">
                          <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                          <strong>Informações adicionada com sucesso!</strong><a href="" class="alert-link"></a>.
                          </div>
                          '; 
                        $_SESSION['cad_infor']=0; 
                      }
                  }
                  if (isset($_SESSION['editar_infor'])) {
                      if ( $_SESSION['editar_infor']== 1 ) {
                      echo '
                          <br>
                          <div class="alert alert-success " id="success-alert">
                          <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                          <strong>Informações editadas com sucesso!</strong><a href="" class="alert-link"></a>.
                          </div>
                          '; 
                        $_SESSION['editar_infor']=0; 
                      }
                  }
                  if (isset($_SESSION['exc_infor'])) {
                      if ( $_SESSION['exc_infor']== 1 ) {
                      echo '
                          <br>
                          <div class="alert alert-success " id="success-alert">
                          <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                          <strong>Excluido com sucesso!</strong><a href="" class="alert-link"></a>.
                          </div>
                          '; 
                        $_SESSION['exc_infor']=0; 
                      }
                  }
                   ?>
               <div class="logo col-md-12">
                  <table class="table">
                     ...
                     <tbody>
                        <tr>
                           ...
                           <td><a type="submit" class="btn btn-danger" href="?pg=processo_seletivo&acao=excluir_informacoes&id=<?php echo $dados->id?>">Excluir</a></td>
                        </tr>
                     </tbody>
                     <?php
                        }
         ...
         <div class="box-body">
            <div class="logo col-md-12">
               <?php 
                  ...
                  ?>
               <div class="row">
                  <form class="form-horizontal" action="?pg=processo_seletivo&acao=edit_informacoes&id=<?php echo $dados->id ?>" method="POST">
                     <div class="box-body">
                        <div class="form-group">
                           <label for="nome" class="col-sm-2"></label> 
                        </div>
   ...
   <div class="row">
      <div class="col-md-12">
         <div class="box box-success">
            ...
            <div class="box-body">
               <div class="logo col-md-12">
                  <form class="form-horizontal" method="POST" action="?pg=processo_seletivo&acao=cad_cursos">
                     <div class="box-body">
                        <div class="form-group">
                           <label for="nome" class="col-sm-2"></label> 
                        </div>
   ...
   <div class="row">
      <div class="col-md-12">
         <div class="box box-success">
            ...
            <div class="box-body">
               <?php 
                  if (isset($_SESSION['cad_cursos'])) {
                      if ( $_SESSION['cad_cursos']== 1 ) {
                      echo '
                          <br>
                          <div class="alert alert-success " id="success-alert">
                          <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                          ...
                          '; 
                        $_SESSION['cad_cursos']=0; 
                      }
                  }
                  if (isset($_SESSION['edi_cursos'])) {
                      if ( $_SESSION['edi_cursos']== 1 ) {
                      echo '
                          <br>
                          <div class="alert alert-success " id="success-alert">
                          <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                          ...
                          '; 
                        $_SESSION['edi_cursos']=0; 
                      }
                  }
                  if (isset($_SESSION['exc_cursos'])) {
                      if ( $_SESSION['exc_cursos']== 1 ) {
                      echo '
                          <br>
                          <div class="alert alert-success " id="success-alert">
                          <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                  ...
                  <table class="table">
                     ...
                     <tbody>
                        <tr>
                           ...
                           <td><a type="submit" class="btn btn-danger" href="?pg=processo_seletivo&acao=excluir_cursos&id=<?php echo $dados->id?>">Excluir</a></td>
                        </tr>
                     </tbody>
                     <?php
                        }
      ...
      <div class="box box-success">
         ...
         <div class="box-body">
            <div class="logo col-md-12">
               ...
               <div class="row">
                  <!-- form start -->
                  <form class="form-horizontal" method="POST" action="?pg=processo_seletivo&acao=edi_cursos&id=<?php echo $dados->id ?>">
                     <div class="box-body">
                        <div class="form-group">
                           <label for="nome" class="col-sm-2"></label> 
                        </div>
   ...
   <div class="row">
      <div class="col-md-12">
         <div class="box box-success">
            ...
            <div class="box-body">
               <div class="logo col-md-12">
                  <form class="form-horizontal" method="POST" action="?pg=processo_seletivo&acao=cad_inscricoes">
                     <div class="box-body">
                        <div class="form-group">
                           <label for="nome" class="col-sm-2"></label> 
                        </div>
   ...
   <div class="row">
      <div class="col-md-12">
         <div class="box box-success">
            ...
            <div class="box-body">
               <?php 
                  if (isset($_SESSION['cad_inscricoes'])) {
                      if ( $_SESSION['cad_inscricoes']== 1 ) {
                      echo '
                          <br>
                          <div class="alert alert-success " id="success-alert">
                          <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                          ...
                          '; 
                        $_SESSION['cad_inscricoes']=0; 
                      }
                  }
                  if (isset($_SESSION['editar_inscricoes'])) {
                      if ( $_SESSION['editar_inscricoes']== 1 ) {
                      echo '
                          <br>
                          <div class="alert alert-success " id="success-alert">
                          <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                          ...
                          '; 
                        $_SESSION['editar_inscricoes']=0; 
                      }
                  }
                  if (isset($_SESSION['exc_inscricoes'])) {
                      if ( $_SESSION['exc_inscricoes']== 1 ) {
                      echo '
                          <br>
                          <div class="alert alert-success " id="success-alert">
                          <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                  ...
                  <table class="table">
                     ...
                     <tbody>
                        <tr>
                           ...
                           <td><a type="submit" class="btn btn-danger" href="?pg=processo_seletivo&acao=excluir_inscricoes&id=<?php echo $dados->id?>">Excluir</a></td>
                        </tr>
                     </tbody>
                     <?php
                        }
      ...
      <div class="box box-success">
         ...
         <div class="box-body">
            <div class="logo col-md-12">
               ...
               <div class="row">
                  <!-- form start -->
                  <form class="form-horizontal" method="POST" action="?pg=processo_seletivo&acao=edi_incricoes&id=<?php echo $dados->id ?>" >
                     <div class="box-body">
                        <div class="form-group">
                           <label for="nome" class="col-sm-2"></label> 
                        </div>
   ...
   <div class="row">
      <div class="col-md-12">
         <div class="box box-success">
            ...
            <div class="box-body">
               <div class="logo col-md-12">
                  <form class="form-horizontal" method="POST" action="?pg=processo_seletivo&acao=cad_resultado">
                     <div class="box-body">
                        <div class="form-group">
                           <label for="nome" class="col-sm-2"></label> 
                        </div>
   ...
   <div class="row">
      <div class="col-md-12">
         <div class="box box-success">
            ...
            <div class="box-body">
               <?php 
                  if (isset($_SESSION['cad_resultado'])) {
                      if ( $_SESSION['cad_resultado']== 1 ) {
                      echo '
                          <br>
                          <div class="alert alert-success " id="success-alert">
                          <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                          ...
                          '; 
                        $_SESSION['cad_resultado']=0; 
                      }
                  }
                  if (isset($_SESSION['editar_resultado'])) {
                      if ( $_SESSION['editar_resultado']== 1 ) {
                      echo '
                          <br>
                          <div class="alert alert-success " id="success-alert">
                          <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                          ...
                          '; 
                        $_SESSION['editar_resultado']=0; 
                      }
                  }
                  if (isset($_SESSION['exc_resultado'])) {
                      if ( $_SESSION['exc_resultado']== 1 ) {
                      echo '
                          <br>
                          <div class="alert alert-success " id="success-alert">
                          <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                  ...
                  <table class="table">
                     ...
                     <tbody>
                        <tr>
                           ...
                           <td><a type="submit" class="btn btn-danger" href="?pg=processo_seletivo&acao=excluir_resultado&id=<?php echo $dados->id?>">Excluir</a></td>
                        </tr>
                     </tbody>
                     <?php
                        }
      ...
      <div class="box box-success">
         ...
         <div class="box-body">
            <div class="logo col-md-12">
               ...
               <div class="row">
                  <!-- form start -->
                  <form class="form-horizontal" method="POST" action="?pg=processo_seletivo&acao=edi_resultado&id=<?php echo $dados->id ?>">
                     <div class="box-body">
                        <div class="form-group">
                           <label for="nome" class="col-sm-2"></label> 
                        </div>
   ...
   <div class="row">
      <div class="col-md-12">
         <div class="box box-success">
            ...
            <div class="box-body">
               <div class="logo col-md-12">
                  <form class="form-horizontal" method="POST" action="?pg=processo_seletivo&acao=cad_alinhamento">
                     <div class="box-body">
                        <div class="col-sm-12">
                           <body>
   ...
   <div class="row">
      <div class="col-md-12">
         <div class="box box-success">
            ...
            <div class="box-body">
               <?php 
                  if (isset($_SESSION['cad_alinhamento'])) {
                      if ( $_SESSION['cad_alinhamento']== 1 ) {
                      echo '
                          <br>
                          <div class="alert alert-success " id="success-alert">
                          <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                          ...
                          '; 
                        $_SESSION['cad_alinhamento']=0; 
                      }
                  }
                  if (isset($_SESSION['editar_alinhamento'])) {
                      if ( $_SESSION['editar_alinhamento']== 1 ) {
                      echo '
                          <br>
                          <div class="alert alert-success " id="success-alert">
                          <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                          ...
                          '; 
                        $_SESSION['editar_alinhamento']=0; 
                      }
                  }
                  if (isset($_SESSION['exc_alinhamento'])) {
                      if ( $_SESSION['exc_alinhamento']== 1 ) {
                      echo '
                          <br>
                          <div class="alert alert-success " id="success-alert">
                          <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                  ...
                  <table class="table">
                     ...
                     <tbody>
                        <tr>
                           ...
                           <td> <a type="submit" class="btn btn-danger" href="?pg=processo_seletivo&acao=excluir_alinhamento&id=<?php echo $dados->id?>">Excluir</a></td>
                        </tr>
                     </tbody>
                     <?php
                        }
      ...
      <div class="box box-success">
         ...
         <div class="box-body">
            <div class="logo col-md-12">
               ...
               <div class="row">
                  <!-- form start -->
                  <form class="form-horizontal" method="POST" action="?pg=processo_seletivo&acao=edit_alinhamento&id=<?php echo $dados->id ?>">
                     <div class="box-body">
                        <div class="form-group">
                           <label for="nome" class="col-sm-2"></label> 
                        </div>
   ...
   <div class="row">
      <div class="col-md-12">
         <div class="box box-success">
            ...
            <div class="box-body">
               <div class="logo col-md-12">
                  <form class="form-horizontal" method="POST" action="?pg=processo_seletivo&acao=cad_matricula">
                     <div class="box-body">
                        <div class="form-group">
   ...
   <div class="row">
      <div class="col-md-12">
         <div class="box box-success">
            ...
            <div class="box-body">
               <?php 
                  if (isset($_SESSION['cad_matricula'])) {
                      if ( $_SESSION['cad_matricula']== 1 ) {
                      echo '
                          <br>
                          <div class="alert alert-success " id="success-alert">
                          <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                          ...
                          '; 
                        $_SESSION['cad_matricula']=0; 
                      }
                  }
                  if (isset($_SESSION['editar_matricula'])) {
                      if ( $_SESSION['editar_matricula']== 1 ) {
                      echo '
                          <br>
                          <div class="alert alert-success " id="success-alert">
                          <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                          ...
                          '; 
                        $_SESSION['editar_matricula']=0; 
                      }
                  }
                  if (isset($_SESSION['exc_matricula'])) {
                      if ( $_SESSION['exc_matricula']== 1 ) {
                      echo '
                          <br>
                          <div class="alert alert-success " id="success-alert">
                          <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                  ...
                  <table class="table">
                     ...
                     <tbody>
                        <tr>
                           ...
                           <td><a type="submit" class="btn btn-danger" href="?pg=processo_seletivo&acao=excluir_matricula&id=<?php echo $dados->id?>">Excluir</a></td>
                        </tr>
                     </tbody>
                     <?php
                        }
      ...
      <div class="box box-success">
         ...
         <div class="box-body">
            <div class="logo col-md-12">
               ...
               <div class="row">
                  <!-- form start -->
                  <form class="form-horizontal" method="POST" action="?pg=processo_seletivo&acao=edit_matricula&id=<?php echo $dados->id ?>">
                     <div class="box-body">
                        <div class="form-group">
                           <label for="nome" class="col-sm-2"></label> 
                        </div>
